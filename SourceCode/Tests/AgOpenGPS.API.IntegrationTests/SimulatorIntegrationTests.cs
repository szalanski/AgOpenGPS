...
public class SimulatorIntegrationTests : BaseIntegrationTest
{
    ...
    public async Task StartSimulatorCommand_ShouldEnableSimulator_AndGenerateGpsData()
    {
        ...
        var startCommand = new UpdateSimulatorCommand(
            SimulatorEvent.Start(new Wgs84Position(45.0, -93.0), new Heading(0.0), new Speed(10.0)) // lat, lon, heading (North), speed
        );
    ...
    public async Task StopSimulatorCommand_ShouldDisableSimulator()
    {
        ...
        await _backendClient!.SendCommandAsync(
            new UpdateSimulatorCommand(SimulatorEvent.Start(new Wgs84Position(45.0, -93.0), new Heading(0.0), new Speed(10.0))));
    ...
    public async Task SetSimulatorSpeedCommand_ShouldChangeSpeed()
    {
        ...
        await _backendClient!.SendCommandAsync(
            new UpdateSimulatorCommand(SimulatorEvent.Start(new Wgs84Position(45.0, -93.0), new Heading(0.0), new Speed(5.0))));
        await Task.Delay(1000);
        ...
        await _backendClient.SendCommandAsync(new UpdateSimulatorCommand(SimulatorEvent.SpeedSet(new Speed(20.0))));
    ...
    public async Task SetSimulatorSteeringCommand_ShouldAffectHeading()
    {
        ...
        await _backendClient!.SendCommandAsync(
            new UpdateSimulatorCommand(SimulatorEvent.Start(new Wgs84Position(45.0, -93.0), new Heading(0.0), new Speed(15.0))));
        await Task.Delay(1000);
        ...
        await _backendClient.SendCommandAsync(new UpdateSimulatorCommand(SimulatorEvent.SteeringSet(new SteeringAngle(20.0))));
    ...
    public async Task ResetSimulatorCommand_ShouldResetState()
    {
        ...
        await _backendClient!.SendCommandAsync(
            new UpdateSimulatorCommand(SimulatorEvent.Start(new Wgs84Position(45.0, -93.0), new Heading(90.0), new Speed(25.0)))); // East at 25 km/h
        await _backendClient.SendCommandAsync(new UpdateSimulatorCommand(SimulatorEvent.SteeringSet(new SteeringAngle(30.0))));
    ...
    public async Task SimulatorPackets_ShouldFlowThroughFullPipeline()
    {
        ...
        await _backendClient!.SendCommandAsync(
            new UpdateSimulatorCommand(SimulatorEvent.Start(new Wgs84Position(45.0, -93.0), new Heading(0.0), new Speed(12.0))));
    ...
    public async Task SimulatorSteering_ShouldCreateCurvedPath()
    {
        ...
        await _backendClient!.SendCommandAsync(
            new UpdateSimulatorCommand(SimulatorEvent.Start(new Wgs84Position(45.0, -93.0), new Heading(90.0), new Speed(15.0)))); // 90° = East
        await Task.Delay(1000);
        ...
        await _backendClient.SendCommandAsync(new UpdateSimulatorCommand(SimulatorEvent.SteeringSet(new SteeringAngle(-25.0))));
    ...
    public async Task SimulatorZeroSpeed_ShouldNotMove()
    {
        ...
        await _backendClient!.SendCommandAsync(
            new UpdateSimulatorCommand(SimulatorEvent.Start(new Wgs84Position(45.0, -93.0), new Heading(45.0), new Speed(0.0)))); // Heading NE but no speed
        await Task.Delay(2500);
    ...
    public async Task ComplexScenario_MultipleCommandSequence()
    {
        ...
        await _backendClient!.SendCommandAsync(
            new UpdateSimulatorCommand(SimulatorEvent.Start(new Wgs84Position(45.0, -93.0), new Heading(0.0), new Speed(5.0)))); // North at 5 km/h
        await Task.Delay(1000);
        ...
        // Act 3: Turn right
        await _backendClient.SendCommandAsync(new UpdateSimulatorCommand(SimulatorEvent.SteeringSet(new SteeringAngle(15.0))));
        await Task.Delay(1500);
        ...
        // Act 4: Slow down
        await _backendClient.SendCommandAsync(new UpdateSimulatorCommand(SimulatorEvent.SpeedSet(new Speed(8.0))));
        await Task.Delay(1000);
